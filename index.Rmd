...
Row {data-height=105}
----------------------------------------
![](/capstone/energysiting/data/intermediate_files/windpowersun.png){data-height=100px}
...
```{r}
load("/capstone/energysiting/data/analysis/m1_wind.rda")

m1_wind %>% broom::tidy() %>% kableExtra::kable(digits = 3,
    align = "c")
```
