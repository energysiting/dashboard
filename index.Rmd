...
The original data can be accessed through this [link](https://www.ncsl.org/research/energy/renewable-portfolio-standards.aspx).
...
```{r}
load("/capstone/energysiting/data/analysis/glm1_wind.rda")

glm1_wind %>% broom::tidy() %>% kableExtra::kable(digits = 3,
    align = "c")
```
...
![](/capstone/energysiting/data/analysis/windtermplot.png){width=400px}  
...
![](/capstone/energysiting/data/analysis/windpairplot.png){width=400px}  
...
![](/capstone/energysiting/data/analysis/solarmaxentterm.png){width=400px}  
...
### Random Forest
```{r, fig.asp=0.6}
display_continuous("analysis/randomForest_Pred_wind_2017.tif")
```
```{r}
...
### Lasso Interactive
```{r, fig.asp=0.6}
display_mapview_quality("analysis/logReg_Pred_lasso_wind_2017.tif", layer_name = "Lasso_wind")
```
```{r}
...
```{r}
load("/capstone/energysiting/data/analysis/glm1_solar.rda")

glm1_solar %>% broom::tidy() %>% kableExtra::kable(digits = 3,
    align = "c")
```
...
![](/capstone/energysiting/data/analysis/solartermplot.png){width=400px}
...
![](/capstone/energysiting/data/analysis/solarpairplot.png){width=400px}
...
### Random Forest
```{r, fig.asp=0.6}
display_continuous("analysis/randomForest_Pred_solar_2017.tif")
```
```{r}
...
### Lasso Interactive
```{r, fig.asp=0.6}
display_mapview_quality("analysis/logReg_Pred_lasso_solar_2017.tif", layer_name = "Lasso_solar")
```
```{r}
