...
display_mapview_quality <- function(file, layer_name = "value", legend = TRUE) {
  ...
  mapview::mapView(x, trim = FALSE, layer.name = layer_name, alpha.regions = 0.7, na.color = "transparent", legend = legend, maxpixels = 700000)
}
...
### Region- Texas
```{r, fig.asp=0.6}
display("processed_data/variables/region_tx.tif")
```
```{r}
...
```{r}
dt("processed_data/variables/region_tx.tif")
```
