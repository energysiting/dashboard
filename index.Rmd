...
display_mapview_quality <- function(file, layer_name = "value", legend = TRUE) {
  ...
  mapview::mapView(x, trim = FALSE, layer.name = layer_name, alpha.regions = 0.7, na.color = "transparent", legend = legend, maxpixels = 2000000, col.regions = rev(terrain.colors(50)))
}
