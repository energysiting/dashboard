...
```{r}
include_graphics("/capstone/energysiting/data/analysis/solarcorrplot.png")
```
```{r}
...
```{r}
include_graphics("/capstone/energysiting/data/analysis/solartermplot.png")
```
```{r}
...
```{r}
include_graphics("/capstone/energysiting/data/analysis/solarpairplot.png")
```
```{r}
...
```{r}
include_graphics("/capstone/energysiting/data/analysis/solarrfvip.png")
```
```{r}
...
```{r}
include_graphics("/capstone/energysiting/data/analysis/solarmaxentvip.png")
```
```{r}
...
```{r}
include_graphics("/capstone/energysiting/data/analysis/solarmaxentterm.png")
```
```{r}
...
```{r, out.height = 10}
display_table("analysis/existing_cov_solar_2017.csv")
```
...
### LogReg Interactive
```{r, fig.asp=0.6}
display_mapview("analysis/logReg_Pred_wind_2017.tif", layer_name = "LogReg_wind")
```
```{r}
...
```{r, fig.asp=0.6}
display_mapview("analysis/randomForest_Pred_wind_2017.tif", layer_name = "RF_wind")
```
```{r}
...
### Maxent Interactive
```{r, fig.asp=0.6}
display_mapview("analysis/Maxent_Pred_wind_2017.tif", layer_name = "Maxent_wind")
```
```{r}
...
### LogReg Interactive
```{r, fig.asp=0.6}
display_mapview("analysis/logReg_Pred_solar_2017.tif", layer_name = "LogReg_solar")
```
```{r}
...
###  Random Forest Interactive
```{r, fig.asp=0.6}
display_mapview("analysis/randomForest_Pred_solar_2017.tif", layer_name = "RF_solar")
```
```{r}
...
### Maxent Interactive
```{r, fig.asp=0.6}
display_mapview("analysis/Maxent_Pred_solar_2017.tif", layer_name = "Maxent_solar")
```
```{r}
